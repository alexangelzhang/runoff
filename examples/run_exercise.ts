...
async function main() {
  ...
  console.log("Target: src/math_processor.ts (Sync -> Async Refactor)");
  
  const prompt = `Refactor MathProcessor.process in src/math_processor.ts to be async with a 100ms delay.
