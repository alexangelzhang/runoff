...
async function runIntegrationTest(options: Options, reportDir: string): Promise<number> {
  ...
  const env = {
    ...
    RUNOFF_RUN_REAL_RACE_SMOKE: options.runRace ? "1" : "0",
    RUNOFF_REAL_SMOKE_ARTIFACT_ROOT: caseDir,
    RUNOFF_REAL_SMOKE_SANDBOX_ROOT: sandboxDir,
    RUNOFF_REAL_SMOKE_KEEP_SANDBOX: "1",
  };
  ...
  writeJson(join(reportDir, "invocation.json"), {
    ...
    keepSuccessSandboxes: options.keepSuccessSandboxes,
    env: {
      RUNOFF_RUN_REAL_PROVIDER_SMOKE: env.RUNOFF_RUN_REAL_PROVIDER_SMOKE,
      RUNOFF_RUN_REAL_RACE_SMOKE: env.RUNOFF_RUN_REAL_RACE_SMOKE,
      RUNOFF_REAL_SMOKE_ARTIFACT_ROOT: env.RUNOFF_REAL_SMOKE_ARTIFACT_ROOT,
      RUNOFF_REAL_SMOKE_SANDBOX_ROOT: env.RUNOFF_REAL_SMOKE_SANDBOX_ROOT,
      RUNOFF_REAL_SMOKE_KEEP_SANDBOX: env.RUNOFF_REAL_SMOKE_KEEP_SANDBOX,
      RUNOFF_REAL_TIMEOUT_MS: env.RUNOFF_REAL_TIMEOUT_MS,
    },
  });
