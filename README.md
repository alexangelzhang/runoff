...
| `runoff_harness_evolve` | Harness evolution: coreset, manifest, isolated proposer + observed variant diff, acceptance guard |
...
| Harness evolution substrate | ✅ manifest/propose/diff/gate/accept | DIY | DIY | DIY | partial |
