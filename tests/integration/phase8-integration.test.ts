...
import { buildAgentCardRegistry, wireA2ATransportFromRegistry } from "../../src/experimental/a2a/config-bridge.ts";
...
test("PipelineHooks otelExport captures trace", async () => {
  resetPipelineOtelExporter();
  resetSharedMemory();
