...
| Harness evolution substrate | `runoff_harness_evolve` · `src/orchestration/harness-evolution.ts` · change manifest, held-in/out gate, variant isolation, coreset, self-preference rank, accept/rollback audit |
