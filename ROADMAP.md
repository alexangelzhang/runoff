...
| Harness evolution substrate | `runoff_harness_evolve` · `src/orchestration/harness-evolution.ts` · failure signature mining, change manifest, isolated proposer, history context, observed variant diff, held-in/out gate, variant isolation, coreset, self-preference rank, acceptance guard/rollback audit, promotion bundle export |
