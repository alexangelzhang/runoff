...
- **Retrieval**：本地 `semanticQuery` + pattern 联想；外置 Mem0/Zep **write-through + MCP `retrieveMerged`**（[`memory-production.md`](memory-production.md)）
- **可观测 / Eval**：[`observability.md`](observability.md) → Dreamify 目标函数
...
- MCP：`llm_dreamify_tune` · [`docs/dreamify.md`](dreamify.md)
...
- [`memory-production.md`](memory-production.md) — 外置 Mem0/Zep
- [`external-memory.md`](external-memory.md) — HTTP 契约
- [`observability-eval.md`](observability-eval.md) — Dreamify 输入
- [`pipeline-hooks-runtime.md`](pipeline-hooks-runtime.md) — 热路径钩子
