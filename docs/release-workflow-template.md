...
- Real provider secrets and login state are already prepared as described in `docs/real-provider-smoke-runner-checklist.md`
...
- `docs/real-provider-smoke.md`
- `docs/real-provider-smoke-runner-checklist.md`
