...
```typescript
import { deleteFederatedAgentCard, compactFederationTombstones } from "./orchestration/a2a/federation-delete.js";
...
```typescript
import { deleteFederatedAgentSkill } from "./orchestration/a2a/federation-delete.js";
...
```typescript
import { probeFederationPeers } from "./orchestration/a2a/federation-ha.js";
