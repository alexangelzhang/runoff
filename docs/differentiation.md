...
See [`coding-agent-backends.md`](coding-agent-backends.md).
...
**Evidence:** `docs/observability.md`, `src/pipeline-hooks.ts`.
...
- Narrow **reflect → re-plan** on review failure / step failure (`docs/deerflow-reflect.md`).
...
- [`coding-agent-backends.md`](coding-agent-backends.md) — Codex, Gemini, Claude Code, OpenCode
- [`industry-benchmark.md`](industry-benchmark.md) — pinned SHA tactical refs
- [`OPEN_SOURCE.md`](OPEN_SOURCE.md) — release checklist
- [`observability.md`](observability.md) — trace + experiment
