...
For reproducible token-cost measurements across 10 task scenarios:

→ [**benchmarks-data.md**](benchmarks-data.md) — generated by `npm run benchmark`, shows single-model vs race token overhead
